...
// Metric is a single runtime metric.
type Metric struct {
...
const file_internal_proto_metrics_proto_rawDesc = "" +
	...
	"\aMetrics\x12N\n" +
	"\rUpdateMetrics\x12\x1d.metrics.UpdateMetricsRequest\x1a\x1e.metrics.UpdateMetricsResponseB5Z3github.com/Dja-tiger/metrics-service/internal/protob\x06proto3"
